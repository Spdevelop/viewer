<template>
  <section class="section-padding bg-gray-900 text-white py-24 p-10">
    <div class="container-custom">
      ...
      <div class="text-center mb-20 animate-fade-in-up">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            class="bg-transparent text-white border-2 border-white hover:bg-white hover:text-gray-900 font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105">
            Schedule Demo
          </button>
        </div>
      </div>
      ...
      <div class="border-t border-gray-800 pt-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <!-- Company Info -->
          <div class="md:col-span-2 animate-fade-in-up" style="animation-delay: 200ms;">
            <div class="text-2xl font-bold text-gradient mb-6">CompanyName</div>
          ...
          <div class="animate-fade-in-up" style="animation-delay: 400ms;">
            ...
            <ul class="space-y-3">
              ...
              <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Documentation</a>
              </li>
            </ul>
          </div>
        ...
        <!-- Bottom Footer -->
        <div class="border-t border-gray-800 pt-12 mt-12 text-center text-gray-400 animate-fade-in-up"
          style="animation-delay: 800ms;">
          <p>&copy; 2024 CompanyName. All rights reserved. | Privacy Policy | Terms of Service</p>
        </div>
      </div>
    </div>
  </section>
